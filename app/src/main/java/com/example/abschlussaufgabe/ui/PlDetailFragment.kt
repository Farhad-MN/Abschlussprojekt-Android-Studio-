...
class PlDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ArrayAdapter.createFromResource(this.requireContext(),R.array.sport_activity,android.R.layout.simple_spinner_item).also {
                arrayAdapter ->
        ...
        ArrayAdapter.createFromResource(this.requireContext(),R.array.fitness_level,android.R.layout.simple_spinner_item).also {
                arrayAdapter ->
            arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_item)
        ...
        binding.btnSpeicher.setOnClickListener {
            val navController= binding.plDetailLayout.findNavController()
